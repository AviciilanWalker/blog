...
![LLM 技术进化速览](/images/tech_timeline.png)
...
![Prompt 的五层结构](/images/prompt_structure.png)
...
不需要装任何软件、不用写一行代码，打开浏览器就能做：

```
□ 翻译: "把下面这段英文翻译成中文：[贴一篇你感兴趣的英文文章片段]"
□ 总结: "用 200 字总结以下文章的核心观点：[贴一篇长文章]"
□ 大白话: 把一页晦涩的教科书内容扔给 AI，让它"用初中生能听懂的话重写一遍"
□ 解释: "请用简单的语言解释什么是人工智能，和机器学习有什么区别"
□ 纠错: 写一段逻辑混乱的文字（故意前后矛盾），看 AI 能不能帮你理清楚
□ 创意: "我是西语专业大一新生，帮我想 5 个适合我的 AI 工具使用场景"
□ 对比: 同一个问题分别问豆包、DeepSeek、Kimi，感受不同模型的风格差异
□ 追问: 模型回答后追一句"能举个生活中的例子吗？"或"有没有更好的方案？"
```

做完这些实验，你会对 AI 能帮你干什么、不擅长什么有个大致的直觉。关键是动手试，不是一次问完就关掉——反复追问、换角度问，收获会完全不同。
...
![LLM 能力三层次](/images/capability_hierarchy.png)
